    ...
    if what == "1":
        ...
        if rmenu == "y":
            ...
            if rmenu == "y":
                ...
                os.system("packages install -y python")
                print("Installing youtube downloader......")
                os.system("yes | pip install youtube-dl")
                print("Creating directory Youtube......")
                os.system("mkdir ~/storage/shared/Youtube")
                print("Creating config for youtube..")
                os.system("mkdir -p ~/.config/youtube-dl")
                print("Creating Bin directory")
                os.system("mkdir ~/bin")
                print("Downloading and installing termux-url-opener")
                os.system("wget http://pastebin.com/raw/LhDxGbtY -O ~/bin/termux-url-opener")
                os.system("dos2unix ~/bin/termux-url-opener")
                print("====================================")
                print("[+] Youtube installed successfully :)")
                print("====================================")
                rmenu = input("[?] Back to Menu? (y/n): ")
                if rmenu == "y":
                   menu()
